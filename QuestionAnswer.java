...
public class QuestionAnswer {
    ...
    public static String options[][]={ {"JVM" , "Dalvik virtual machine", "Simple virtual machine", "None of the above"} ,
            ...
            {"Google" , "Apple" ,"Nokia" , "Apple"} ,
            {"HTC Hero", "Google gPhone", "T - Mobile G1","None of the above"},
            {"3" ,"243" , "343" ,"81"}

    };

    public static String answers[]={ "Dalvik virtual machine", "Apache/MIT" , "Google","T - Mobile G1", "243"};
